...
angular.module('galleryApp')
	.config(['$sceDelegateProvider', function($sceDelegateProvider) {
		$sceDelegateProvider.resourceUrlWhitelist(['self', 'chrome://zooniversexpert/**/*.html']);
	}])
	.directive('gallery', function ($timeout, $swipe) {
		'use strict';
		...
		return {
			...
			templateUrl : 'chrome://zooniversexpert/content/resources/directives/angular-gallery.html'
		};
	});